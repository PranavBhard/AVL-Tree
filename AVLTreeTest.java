...
public class AVLTreeTest {
	...
	String[] treelevelorder = {"B", "A", "C"};
	String[] treelevelorder2 = {"E", "C", "J", "B", "F", "M"};
	String[] treelevelorder3 = {"J", "F", "M", "E", "G", "N"};
	...
	public void testLeftRotation() {
		...
		for (int i = 0; i < list.size(); i++) {
			assertEquals(treelevelorder[i], list.get(i));
		}				
	}
	...
	public void removeFromEmptyTree() {
		...
		assertEquals(false, tree.remove("A"));
	}
	
	@Test
	public void testRightRotateWithSubtrees() {
		tree.add("J");
		tree.add("E");
		tree.add("M");
		tree.add("C");
		...
		List<String> list = tree.getLevelOrder();
		for (int i = 0; i < list.size(); i++) {
			assertEquals(treelevelorder2[i], list.get(i));
		}
	}
	
	@Test
	public void testRotateLeftRightNotRoot() {
		tree.add("J");
		tree.add("G");
		tree.add("M");
		tree.add("E");
		...
		List<String> list = tree.getLevelOrder();
		for (int i = 0; i < list.size(); i++) {
			assertEquals(treelevelorder3[i], list.get(i));
		}
	}
